...
public class StarBox extends GameObject {

    private boolean isEmpty;

    public StarBox() { //vacio para factoria
        super();
        this.isEmpty = false;
    }

    public StarBox(GameWorld game, Position pos, boolean empty) { //constructor default
        super(game, pos);
        this.isEmpty = empty;
    }
    ...
    @Override
    public void update() {
        //tristemente Starbox no se mueve
    }
    ...
    public GameObject parse(String[] words, GameWorld game) {
        ...
        if (!GameObject.matchesType(words[1], "STARBOX", "SB"))
            return null;
        ...
        return new StarBox(game, p, empty);
    }
    ...
    public String toString() { //pal save, que no me salga tp1.logic.gameobjects.Goomba@123patatas
        ...
        return "(" + p.getRow() + "," + p.getCol() + ") StarBox " + state;
    }
